...
process_hotspot_co2=(results.groupby('ID proceso')['Emisiones kg CO2-eq'].sum()).loc[results['Emisiones kg CO2-eq'].idxmax(),'ID proceso']
#process_hotspot_co2=process_hotspot_co2i.
