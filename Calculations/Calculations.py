...
process_hotspot_co2i=results.groupby('ID proceso')['Emisiones kg CO2-eq'].sum()
process_hotspot_co2=process_hotspot_co2i.loc[results['Emisiones kg CO2-eq'].idxmax(),'ID proceso']
